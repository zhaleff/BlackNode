...
hl.curve("emphasizedDecel",   { type = "bezier", points = { {0.06, 0.90}, {0.20, 1.00} } })
...
hl.curve("overshoot",         { type = "bezier", points = { {0.34, 1.20}, {0.64, 1.00} } })
hl.curve("snappy",            { type = "bezier", points = { {0.10, 0.90}, {0.16, 1.00} } })
...
hl.animation({ leaf = "fadeSwitch",    enabled = true, speed = 3,  bezier = "snappy" })
...
hl.animation({ leaf = "zoomFactor",    enabled = true, speed = 4,  bezier = "emphasizedDecel" })

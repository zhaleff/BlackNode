return {
  {
    ...
    config = function()
      ...
      ctp_feline.setup({
        ...
        custom = {
          vi_mode_colors = {
            NORMAL   = { fg = C.base, bg = C.blue },
            INSERT   = { fg = C.base, bg = C.green },
            VISUAL   = { fg = C.base, bg = C.mauve },
            LINES    = { fg = C.base, bg = C.mauve },
            BLOCK    = { fg = C.base, bg = C.mauve },
            REPLACE  = { fg = C.base, bg = C.red },
            COMMAND  = { fg = C.base, bg = C.yellow },
            TERMINAL = { fg = C.base, bg = C.teal },
          },
        },
      })
